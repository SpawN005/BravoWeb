...
class BlogController extends AbstractController
{
    ...
    public function indexMyblogs(): Response
    {
        ...
        $blogs = $r->findByAuthor($this->getUser());
        return $this->render('blog/index.html.twig', [
            'controller_name' => 'BlogController',
            'blog' => $blogs,
            'myblogs' => $bool
    ...
    #[Route('/artiste/blog/new', name: 'app_new_blog')]
    ...
    #[Route('/artiste/deleteB/{id}', name: 'app_delete_blog')]
    ...
    #[Route('/artiste/updateB/{id}', name: 'app_update_blog')]
    ...
    public function show($id, BlogRepository $rep, Request $request, NoteBlogRepository $nb): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $userId = 3; // Change this to the ID of the user you want to rate the blog
            ...
            if ($existingNote) {
                ...
                //     return $this->redirectToRoute('app_detail_blog', ['blog' => $blogs,
                //     'blogId' => $blogId,
                //     'note' =>$note,
