...
class EventController extends AbstractController
{
    ...
    #[Route('/event', name: 'app_eventFeed')]
    ...
    #[Route('/admin/detailEvent/{id}', name: 'app_detailEvent', methods: ["GET", "POST"])]
    ...
    #[Route('/admin/deleteEvent/{id}', name: 'app_deleteEvent')]
    public function deleteEvent($id, EventRepository $rep, ReservationRepository $reservationRep, ManagerRegistry $doctrine, SessionInterface $session, Swift_Mailer $mailer): Response
    {
        ...
        $s = $reservationRep->findBy(['id_event' => $event]);
    ...
    #[Route('/admin/addEvent', name: 'app_addEvent')]
    ...
    #[Route('/admin/updateEvent/{id}', name: 'app_updateEvent')]
