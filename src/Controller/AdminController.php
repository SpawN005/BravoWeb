...
class AdminController extends AbstractController
{
    ...
    #[Route('/UserList', name: 'adminbacks', methods: ['GET', 'POST'])]

    public function AddAdmin(Request $request, ManagerRegistry $doctrine, UserRepository $repository, PaginatorInterface $paginator)
    {
        $user = new User();
        $userClient = $repository->findAll();
        $userAdmin = $repository->findByRole('ROLE_ADMIN');
    ...
    #[Route('/user/ban/{id}', name: 'banUser')]
