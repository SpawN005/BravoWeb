...
class ReservationController extends AbstractController
{
    ...
    #[Route('/user/reservationUser', name: 'app_reservationUser')]
    public function reservationUser(EntityManagerInterface $entityManager)
    {
        $user = $this->getUser();
        if (!$user) {
    ...
    #[Route('/admin/deleteReservation/{id}', name: 'app_deleteReservation')]
    ...
    // }
    #[Route('/user/deleteReservationUser/{id}', name: 'app_deleteReservationUser')]
    ...
    #[Route('/user/addReservation/{id}', name: 'app_addReservation')]
    ...
    #[Route('/user/updateReservation/{id}', name: 'app_updateReservation')]
