...
{
    #[Route('/admin/categorie/blog', name: 'app_categorie_blog')]
    ...
    #[Route('/admin/newCategorieBlog', name: 'app_new_categorie_blog')]
    ...
    #[Route('/admin/deleteCategorie/{id}', name: 'app_delete_categorie')]
    public function deleteBlog(
        $id,
        CategorieBlogRepository $rep,
    ...
    #[Route('/admin/updateCategorie/{id}', name: 'app_update_categorie')]
