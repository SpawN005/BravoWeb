...
class ReclamationController extends AbstractController
{
    ...
    #[Route('/admin/readReclamation/{etat}', name: 'app_readR', methods: ['GET'])]
    ...
    public function addReclamation(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $reclamation->setOwnerid($this->getUser());
    ...
    public function userReclamations(ReclamationRepository $r, PaginatorInterface $paginator, Request $request)
    {
        ...
        $reclamations = $r->findByOwnerid($user); // récupérer les réclamations de l'utilisateur
    ...
    #[Route('/admin/traiterReclamation/{id}', name: 'reclamation_traiter')]
    ...
    #[Route('/admin/genererPdf', name: 'genererPdf')]
    ...
    #[Route('/admin/genererstats', name: 'genererstats')]
