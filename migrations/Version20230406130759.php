 ...
 */
final class Version20230406130759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_blog (id INT AUTO_INCREMENT NOT NULL, NomCategorie VARCHAR(100) NOT NULL, UNIQUE INDEX NomCategorie (NomCategorie), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE categorie_event (id INT AUTO_INCREMENT NOT NULL, NomCategorie VARCHAR(100) NOT NULL, UNIQUE INDEX NomCategorie (NomCategorie), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
