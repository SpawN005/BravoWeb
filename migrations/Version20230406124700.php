 ...
 */
final class Version20230406124700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_blog (id INT AUTO_INCREMENT NOT NULL, NomCategorie VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie_donation (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie_event (id INT AUTO_INCREMENT NOT NULL, NomCategorie VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, categorie INT DEFAULT NULL, title VARCHAR(30) NOT NULL, description VARCHAR(100) NOT NULL, nb_placeMax INT NOT NULL, date_beg DATE NOT NULL, date_end DATE NOT NULL, url VARCHAR(255) NOT NULL, INDEX FK_eventcat (categorie), UNIQUE INDEX uk_title (title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, firstName VARCHAR(30) NOT NULL, lastName VARCHAR(30) NOT NULL, phoneNumber INT NOT NULL, email VARCHAR(30) NOT NULL, role VARCHAR(30) NOT NULL, PASSWORD VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT \'\'\'aze.png\'\'\', checker VARCHAR(200) DEFAULT \'\'\'usable\'\'\' NOT NULL, UNIQUE INDEX email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
