    ...
    ManagerRegistry $doctrine): Response
{
    ...
    #[Route('/readBlog/{id}', name: 'app_read_blog')]
    public function readBlog(Request $request, BlogRepository $blogRepository): Response
    {
        $id = $request->get('id');
        ...
        if (!$blog) {
            throw $this->createNotFoundException('Le blog n\'existe pas.');
        }
    
        // Générer l'URL de la route pour la notation
        $newNoteRoute = $this->generateUrl('app_new_note_blog', ['blogId' => $id]);
